              ...
              <form method="post" action="php/admin_actions.php?updateprofile">
                ...
                <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <input type="password" name="password" value="<?=$admin['password_text']?>" class="form-control" id="exampleInputPassword1" placeholder="Password">
                  </div>
...
?>
  ...
  <footer class="main-footer">
    <strong>Copyright &copy; 2022 <a href="https://www.facebook.com/zolmkoz.official" target="_blank">zolmkoz</a>.</strong>
    All rights reserved.
